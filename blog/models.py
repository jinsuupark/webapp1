...
class Post(models.Model):
    ...
    read_cnt = models.IntegerField(verbose_name='READ_CNT',max_length=11,default=0)
...
class PostAttachFile(models.Model):
    ...
    content_type=models.CharField(max_length=128,null=True,verbose_name='MINE TYPE')
